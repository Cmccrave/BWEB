...
namespace BWEB
{
	void findWalls()
	{
		TilePosition secondChoke = BWEBClass::getSecondChoke();
		TilePosition natural = BWEBClass::getNatural();
		Area const * naturalArea = BWEBClass::getNaturalArea();
		...
		BWEBClass::walls[naturalArea] = naturalWall;
